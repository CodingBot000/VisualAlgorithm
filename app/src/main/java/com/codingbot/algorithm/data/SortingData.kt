...
data class SortingHeapDataResult(val sortingDataList: MutableList<SortingData>, val resultList: MutableList<SortingData>? = null, val swapTargetIdx1: Int = 0, val swapTargetIdx2: Int = 0)